          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <h3><strong>Register</strong> a Firm Profile</h3>
               <h4> Select Team</h4>
               after each select display lawyer photo and they can search again 
               <div class="contact-form">
                
                <form action="#" class="comment-form">
                
                 <input type="text" placeholder="Enter Lawyer LSK Number (can only get registered lawyers)" required> &nbsp;&nbsp; <a class="btn btn-default" href="#"><i class="fa fa-envelope-o"></i>Get Lawyer Details</a>
                 <br/><br/>
                 
              
                  <a class="btn btn-default" href="firmregister.html"><i class="fa fa-envelope-o"></i>Previous</a>
                    &nbsp;&nbsp;<a class="btn btn-default" href="{{url('firm/whyregister/firm_register3')}}"><i class="fa fa-envelope-o"></i>Save and Next</a>
                </form>
                </div>
<!-- end .contact-form -->
