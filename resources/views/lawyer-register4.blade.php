               ...
               <div class="contact-form">
                ...
                <form action="/lawyer/case" method="POST" class="comment-form">
                   ...
                   <input type="text" placeholder="Enter Case Name in Full" name="case_name" required>
                    <input type="text" placeholder="Enter Country" name="case_country" required>
                    
                    <input type="text" placeholder="Enter Town" name="case_town"required>
                   
                     {{-- <input type="date" placeholder="Enter Date Case Started(Put a date select here)" required name="case_date"> --}}
                ...
                <a class="btn btn-default" href="#"><i class="fa fa-envelope-o"></i>Add Another Case</a>
                  &nbsp;&nbsp;<a class="btn btn-default" href="{{url('lawyer/whyregister/register3')}}"><i class="fa fa-envelope-o"></i>Previous</a>
                    &nbsp;&nbsp;<a class="btn btn-default" href="{{url('lawyer/whyregister/register5')}}"><i class="fa fa-envelope-o"></i>Save and Next</a>
                </form>
                </div>
<!-- end .contact-form -->
