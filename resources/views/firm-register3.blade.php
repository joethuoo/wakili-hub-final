...
<!-- end .contact-form -->
     ...
     <h4> PROFESSIONAL ASSOCIATIONS</h4> 
               <div class="contact-form">
                ...
                <a class="btn btn-default" href="#"><i class="fa fa-envelope-o"></i>Add Another</a>
                  &nbsp;&nbsp;<a class="btn btn-default" href="{{url('firm/whyregister/firm_register2')}}"><i class="fa fa-envelope-o"></i>Previous</a>
                    &nbsp;&nbsp;<a class="btn btn-default" href="{{url('firm/whyregister/firm_register4')}}"><i class="fa fa-envelope-o"></i>Save and Next</a>
                </form>
                </div>
<!-- end .contact-form -->
