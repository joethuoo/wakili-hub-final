      ...
      <div class="container">
        <nav>
          ...
          <ul class="primary-nav list-unstyled">
            ...
            <li><a href="{{ url('lawyer/lawyers') }}">Lawyers</i></a></li>

            <li class="bg-color"><a href="{{ url('firm') }}">Law Firms</a></li>
            <li><a href="{{ url('firm/jobs') }}">Job Opportunities</a></li>
            <li><a href="{{ url('lawyer/whyregister')}}">Why Register</a></li>
                      ...
                      <div class="single-product">
                        <figure>
                          ...
                          <figcaption>
                            ...
                            <div class="read-more">
                              <a href="{{ url('firm/'.$firm->firm_id.'/readmore')}}"><i class="fa fa-angle-right"></i> Read More</a>
                            </div>
                        ...
                        <h5>{{$firm->firm_practice_name}}</h5>


                        <p>{{$firm->firm_bios}}</p>

                        <a class="read-more" href="{{ url('firm/'.$firm->firm_id.'/readmore')}}"><i class="fa fa-angle-right"></i>Read More</a>
